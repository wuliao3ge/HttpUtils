...
public class FragProgressSubscriber<T> implements Observer<T> {
     ...
     * @param api
     */
    public FragProgressSubscriber(BaseApi api, SoftReference<HttpOnNextListener> listenerSoftReference, SoftReference<RxFragment>
            mActivity) {
        this.api = api;
        this.pd = api.getProgress();
        this.mSubscriberOnNextListener = listenerSoftReference;
        this.mFragment = mActivity;
    ...
    private void initProgressDialog(boolean cancel) {
        RxFragment fr = mFragment.get();
        Context context = fr.getActivity();
